@php
    ...
    $Income_json = json_encode($Income_mains);
...
<x-app-layout>
    ...
    <div class="container px-5 py-12 mx-auto">
        <div class="flex flex-col text-center w-full mb-2">
            <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">投稿編集フォーム</h1>
        </div>
            ...
            <div class="flex flex-col -m-2">
                ...
                <div class="p-2 w-full">
                    <div class="relative">
                        ...
                        <input id="SEL1" name="selection" value="{{ $post->selection }}" readonly class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                </div>
                <div class="p-2 w-full">
                    <div class="relative">
                        ...
                        <select id="SEL2" name="main" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                <option value="" disabled selected style="display:none;">{{ $post->main }}</option>
                            <div id="hidden1">
                            <optgroup label="収入" >
                                    @php
                ...
                <div class="p-2 w-full">
                    <div class="relative">
                        ...
                        <select id="SEL3" name="sub" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            ...
                            <div >
                            <optgroup label="利子">
                            <option value="" disabled selected style="display:none;">{{ $post->sub }}</option>
                                    @php
                ...
                <div class="p-2 w-full">
                    <div class="relative">
                        ...
                        <input type="number" id="amount" name="amount" value="{{ $post->amount }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                    </div>
                </div>
                <div class="p-2 w-full">
                        <div class="relative">
